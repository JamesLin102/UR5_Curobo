"""The Isaac Lab backend: the cell, built on Isaac Lab.
...
cuRobo stays in planner_server.py, reached over the socket: Isaac Lab runs on
Isaac Sim 5.1 and its Warp 1.8.2, and cuRobo 0.8 needs Warp >= 1.13. Nothing under lab/ imports cuRobo.
